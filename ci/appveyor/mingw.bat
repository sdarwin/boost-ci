...
REM The following experiment could not be verified remotely
REM echo     curl -O http://repo.msys2.org/msys/x86_64/msys2-keyring-1~20201002-1-any.pkg.tar.xz
REM echo     curl -O http://repo.msys2.org/msys/x86_64/msys2-keyring-1~20201002-1-any.pkg.tar.xz.sig
REM echo     pacman-key --verify msys2-keyring-1~20201002-1-any.pkg.tar.xz.sig
REM echo     pacman --noconfirm -U msys2-keyring-1~20201002-1-any.pkg.tar.xz
echo     echo "Packages:"
