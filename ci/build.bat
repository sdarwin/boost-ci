...
IF DEFINED SCRIPT (
    ...
    REM Now go build...
    b2 --verbose --abbreviate-paths %B2_TARGETS% %B2_TOOLCXX% %B2_CXXSTD% %B2_CXXFLAGS% %B2_DEFINES% %B2_THREADING% %B2_ADDRESS_MODEL% %B2_LINK% %B2_VARIANT% -j%B2_JOBS% %B2_FLAGS%
)
