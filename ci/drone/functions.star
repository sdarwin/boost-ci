    ...
    "steps": [
      {
        ...
        "commands": [
          ...
          "uname -a",
          # "apt-get -o Acquire::Retries=3 update && apt-get -o Acquire::Retries=3 -y install git",
          "BOOST_CI_ORG=sdarwin BOOST_CI_BRANCH=drone && /usr/local/bin/wget https://github.com/$BOOST_CI_ORG/boost-ci/archive/$BOOST_CI_BRANCH.tar.gz && tar -xvf $BOOST_CI_BRANCH.tar.gz && mv boost-ci-$BOOST_CI_BRANCH .drone/boost-ci",
          "echo '==================================> PACKAGES'",
